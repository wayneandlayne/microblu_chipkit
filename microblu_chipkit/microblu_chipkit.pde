...
//This is Microblu for ChipKIT.  Right now, the WF32 is supported.
...
//Read through this file to setup your Wifi.  You'll need to specify the SSID and password if you have one.
//You probably want WPA2_PASSPHRASE, but maybe you have an access point setup with the other ways.  There are
//examples below.


// Specify the SSID
const char * szSsid = "YOURSSID";
...
// modify the security key to what you have.
    ...
    const char * szPassPhrase = "YOURPASSWORD";
...
char UUID[]  = "59a17dc0-d1e1-11e4-b2d8-81852a5861e1";
char TOKEN[] = "d875feeca2e549c0f81a249468677ea96eaa6ebe";
...
//PubSubClient microblu(server, 1883, onMessage, tcpSocket2);
...
void systemResetCallback()
{
  ...
  for (byte i=0; i < TOTAL_PINS; i++) {
    ...
    // skip SPI pins for /Wifi Shield //JJR
